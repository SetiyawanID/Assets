        ...
        <ul class="sidebar-menu">
            @if(Auth::user()->role == "1")
                ...
                @if (Auth::user()->role != "1")
                    ...
                    <li class="{{ Request::is('admin/my-maintenance*') ? ' active' : '' }}"><a class="nav-link" href="{{ route('mymaintenance.index', Auth::user()->id) }}"><i class="fas fa-wrench"></i> <span>My Maintenance</span></a></li>
                ...
                @if(Auth::user()->role == "1")
                    ...
                    <li class="{{ Request::is('admin/license*') ? ' active' : '' }}"><a class="nav-link" href="{{ route('license.index') }}"><i class="fas fa-check-circle"></i> <span>Licenses</span></a></li>
